...
const Profile = () => {
  ...
  const ResetButtonClicked = () => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        Swal.fire("Deleted!", "Your changes have been deleted.", "success")
      }
    })
  }
    ...
    if (type === "mentor") {
      ...
      if (mentorCheck && menteeCheck) {
        ...
        Swal.fire({
          ...
          text:
            "This connection exists either in your Mentor or Mentee list. Please remove them from these lists before attempting to remove them from your connections list.",
        })
      }
    }
  }
      ...
      <>
        <div className="editMentors">
          ...
          <div className="scrollableMentors">
            {users?.map(
              ({ fullName, position, location, profilePicture, roles }, i) => {
                ...
                if (
                  ...
                  return (
                    <div
                      className="row profileCard editCard"
                      id={idVal}
                      key={i}
                      onClick={() => deleteMenteeMentor("mentor", i)}
                    >
        ...
        {currentUser?.roles?.includes("mentor") ? (
          <div className="editMentees">
            ...
            <div className="scrollableMentees">
              {users?.map(
                (
                  { fullName, position, location, profilePicture, roles },
                  i
                ) => {
                  if (currentUser?.newUser) return null
                  ...
                  if (
                    ...
                    return (
                      <div
                        ...
                        id={idVal}
                        key={i}
                        onClick={() => deleteMenteeMentor("mentee", i)}
                      >
                        <div className="profileCardContent">
                          {profilePicture === "" ? (
                            <img
        ...
        <div className="editConnections">
          ...
          <div className="scrollableConnections ">
            {users?.map(
              ({ fullName, position, location, profilePicture }, i) => {
                if (currentUser?.newUser) return null
                var idVal = `conCard-${i}`
                if (
                  typeof fullName !== "undefined" &&
                  ...
                  return (
                    <div
                      ...
                      id={idVal}
                      key={i}
                      onClick={() => deleteMenteeMentor("connection", i)}
                    >
                      <div className="profileCardContent">
                        {profilePicture === "" ? (
                          <img
                ...
                <div className="col-md-4 skills">
                  <div className="profile-work">
                    ...
                    <Inputs.DropdownSelect
                      defaultValue={
                        categoriesData.filter(({ value }) =>
                          currentUser.toImprove?.includes(value)
                        ) || []
                      }
                    ...
                    <Inputs.DropdownSelect
                      defaultValue={
                        categoriesData.filter(({ value }) =>
                          currentUser.skills?.includes(value)
                        ) || []
                      }
                      options={categoriesData}
        ...
        <div className="row">
          <div className="col-md-12 FAQ">
            <NavLink to="/faq" style={{ textDecoration: "none" }}>
              <Inputs.Button text="FAQ" onClick={() => {}} />
            </NavLink>
          </div>
        </div>
        <div className="row">
          <div className="col-md-12 FAQ">
            <Inputs.Button text="Log Out" onClick={() => dispatch(logOut())} />
          </div>
        </div>
      </div>
    </>
